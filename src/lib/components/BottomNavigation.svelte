...
<nav class="modern-bottom-nav">
	<div class="nav-container">
		...
		<a href="/explore" class="nav-item" class:active={currentPath === '/explore'}>
		...
		<a href="/" class="nav-item home-item" class:active={currentPath === '/'}>
		...
		<a href="/messages" class="nav-item" class:active={currentPath.startsWith('/messages')}>
			<div class="nav-icon-wrapper">
				<div class="indicator">
