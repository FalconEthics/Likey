<script>
  ...
  let canSubmit = $derived(email && password && confirmPassword && 
  ...
  async function handleSignup(event) {
    ...
    if (result.success) {
      if (result.needsConfirmation) {
        ...
        confirmationMessage = result.message || 'Please check your email and click the confirmation link to complete registration.';
...
<div class="modal modal-open">
  <div class="modal-box">
    ...
    <div class="flex items-center justify-center mb-4">
      <img src={LikeyLogo} alt="Likey" class="w-12 h-12 rounded-lg likey-logo" />
    </div>
    
    <h3 class="font-bold text-lg mb-4 text-center likey-gradient-text">Create Account</h3>
    ...
    <form onsubmit={handleSignup} class="space-y-4">
      ...
      <div class="form-control mt-6">
        ...
        >
          {loading ? 'Creating Account...' : confirmationMessage ? 'Check Your Email' : 'Create Account'}
        </button>
      </div>
